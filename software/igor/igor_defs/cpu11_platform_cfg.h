...
/*
** Define a dummy replica index, even though CPU 11 isn't a replica.
** Prevents errors when compiling libraries that used REPLICA_INDEX.
** We do not use these libraries, but the scheduler (which we do need)
** initializes them at startup so exects them to be there.
*/
#define REPLICA_INDEX 0

/*
** CPU Id for target Processor
*/
#define CFE_PLATFORM_CPU_ID 11

/*
** CPU Name for target Processor
*/
#define CFE_PLATFORM_CPU_NAME "CPU11"
/**
...
*/
#define CFE_PLATFORM_TBL_MAX_DBL_TABLE_SIZE    40000
...
*/
#define CFE_PLATFORM_TBL_MAX_SNGL_TABLE_SIZE   40000
